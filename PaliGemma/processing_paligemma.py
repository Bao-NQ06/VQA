...
def add_image_tokens_to_prompt(prefix_prompt, bos_token, image_seq_len, image_token) -> str:
...
class PaliGemmaProcessor:
    ...
    def __init__(self, tokenizer, num_image_tokens: int, image_size: int):
        ...
        ] #Token used for object bounding boxes
        EXTRA_TOKENS += [
            f"<seg{i:03d}>" for i in range(128)
        ] #Token used for object segments
